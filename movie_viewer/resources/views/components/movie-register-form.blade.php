<div class="w-full pb-10 pt-8 border grid grid-cols-5">
    ...
    <form action="{{route('create_movie')}}" method="post" class="p-10 col-start-2 col-end-5">
        @csrf
        ...
        <label>Gênero: <select class="block mt-1 w-full h-10" name="genre" required autofocus>
